...
objects = []
with (open("qa_generator_texts.pkl", "rb")) as openfile:
    while True:
        try:
...
def generate_closed_answer(qaqd_set):
    ...
    for qa_item in qaqd_set:
        ...
        if "NA" in answer:
            ...
            input_text="Task: Answer the question in a detailed fashion. \
            If the question cannot be answered without more information, \
            please answer NA.\nExample 1:\nQuestion: Why does Shala like \
            cookies?\nAnswer: It is not possible to know why Shala likes \
            cookies without more information, but many people that like \
            cookies enjoy their taste or some of their ingredients \
            (e.g. chocolate chips or peanut butter).\nExample 2:\nQuestion: \
            Why would someone vote in an election?\nAnswer: There are many \
            reasons someone might vote in an election, for instance to \
            have their voice heard or to help a candidate they like win the \
            race.\nExample 3\nQuestion: What decoration goes on top of a \
            Christmas tree?\nAnswer: Usually a star is placed at the top of \
            a Christmas tree.\nExample 4:\nQuestion: "+question+"\nAnswer: "
            result=ask_flan_T5D(input_text)
            qaqd_results.add((qa_item[0],qa_item[1],qa_item[2],result))
    return qaqd_results
...
# Generate closed book answer to question.
def generate_closed_answer_prefix(question):
    input_text="Task: Answer the question in a detailed fashion. \
    If the question cannot be answered without more information, \
    please answer NA.\nExample 1:\nQuestion: Why does Shala like \
    cookies?\nAnswer: It is not possible to know why Shala likes \
    ...
    (e.g. chocolate chips or peanut butter).\nExample 2:\nQuestion: \
    Why would someone vote in an election?\nAnswer: There are many \
    reasons someone might vote in an election, for instance to have \
    their voice heard or to help a candidate they like win the \
    race.\nExample 3\nQuestion: What decoration goes on top of a \
    Christmas tree?\nAnswer: Usually a star is placed at the top of \
    a Christmas tree.\nExample 4:\nQuestion: "+question+"\nAnswer: "
...
f = open("qa_generator_dictionary_outputs.pkl","wb")
