...
#Load an array of strings that are are reference or verified knowledge sources for QA generation. You can do this with a pickle, uncomment and add your file name.
objects = []
